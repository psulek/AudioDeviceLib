...
{
    [PreserveSig]
    int Activate(ref Guid iid, CLSCTX dwClsCtx, IntPtr activationParams,
        [MarshalAs(UnmanagedType.IUnknown)] out object ppInterface);

    [PreserveSig]
    int OpenPropertyStore(StgmAccess stgmAccess, [MarshalAs(UnmanagedType.Interface)] out IPropertyStoreCOM propertyStore);
