/*
  ...
  The internal AudioSessionEventsAdapter receives the raw COM callbacks
  (Interfaces.IAudioSessionEvents) and forwards them to an instance of this interface.
*/
...
public interface IAudioSessionEvents
{
    ...
    /// <remarks>Called on an arbitrary, non-UI thread.</remarks>
    void OnSessionDisconnected(AudioSessionBaseInfo session, AudioSessionDisconnectReason disconnectReason);
}